...
if(CROSS_FROM_WINDOWS)
  ...
  set(ARDUINO_ROOT "${CMAKE_SOURCE_DIR}/third_party/tiny-core")
  set(ARDUINO_SRC "${ARDUINO_ROOT}/avr/cores/tiny/")
  include_directories("${ARDUINO_ROOT}/avr/variants/${BOARD_VARIANT}")
endif()

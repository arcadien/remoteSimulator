...
set(ARDUINO_ROOT "${CMAKE_SOURCE_DIR}/third_party/tiny-core/avr")
if(CROSS_FROM_WINDOWS)
  set(ARDUINO_SRC "third_party/tiny-core/avr/cores/tiny/")
  include_directories("${ARDUINO_ROOT}/hardware/arduino/avr/variants/${BOARD_VARIANT}")
  include_directories("third_party/tiny-core/avr/variants/${BOARD_VARIANT}")
